...
public final class Constants {
    ...
    public static final double PI=3.1415926535897931,XEO=8.854187817E-12,XE=1.60217733E-19,XK=1.380658E-23,XN=6.0221367E23;
    public static double NTHETA=3.6297469670513871e-308;
    public  static  double DIPOL=(0.204956E-30/(2.E0*4.E0*PI*XEO))*XE*XE;
    public static double temperature=298.E0;
    ...
    public static final double RO=3.043E0*1.0E-10;
    public static final double DTSF1=0.5E0;
    public static final double  DTSF2=0.1E0;
    public static final double SW1=0.00005E0;
    public static double ROMAX=0.0;
    public static  double SW2=0.005E0;

    public static double EOGAS=0.06900E0;
    public static double ROGAS =3.6600E0;
    public static double CONVE=(4.2E0*0.01036427E0);
    public static double CONVR=0.890898718E0;
